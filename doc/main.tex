...
Pour le choix des hyper paramètres, le but est d'utiliser une méthode de validation croisée pour trouver les meilleurs hyper paramètres pour chacun de nos modèles.
Chacun d'entre eux passera sera créé avec un jeu d'hyper paramètres différent et passera par une validation croisée.
...
Concernant SVM, qui est un modèle qui nécessite beaucoup de temps de calcul
