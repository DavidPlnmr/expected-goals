...
\noindent Il y en a également d'autres comme les expected points qui sont les points qu'une équipe devrait avoir gagnés basé sur les données relatives aux xG. D'autres dérivées sont indiquées sur l'article de Pinnacle écrit par Luke Petty. \cite{pettyWhatExpectedGoals2018a}
\newline\newline
...
\newpage
\noindent La première partie est de transformer les coordonnées X et Y qui sont à l'échelle 100 par 100 en coordonnées X et Y à l'échelle 105 par 68.
...
\noindent Cette section vise à expliquer comment les datasets ont été fusionnés.
...
\noindent Cette section vise à visualiser les données du dataset final.
...
\begin{table}[htp]
    ...
    \begin{tabular}{r|r|r|r|r|r|}
        ...
        \multicolumn{1}{|r|}{\textbf{count}} & 43075      & 43075      & 43075             & 43075          & 43075               \\ \hline
        \multicolumn{1}{|r|}{\textbf{mean}}  & 15.992225  & 33.473176  & 18.593067         & 0.414140       & 0.484041            \\ \hline
        \multicolumn{1}{|r|}{\textbf{std}}   & 8.534333   & 9.366171   & 8.419298          & 0.253173       & 0.313051            \\ \hline
        \multicolumn{1}{|r|}{\textbf{min}}   & 0.000000   & 0.000000   & 0.680000          & 0.000000       & 0.000000            \\ \hline
        \multicolumn{1}{|r|}{\textbf{25\%}}  & 9.450000   & 26.520000  & 12.249445         & 0.250188       & 0.227296            \\ \hline
        \multicolumn{1}{|r|}{\textbf{50\%}}  & 13.650000  & 33.320000  & 17.153297         & 0.327782       & 0.452154            \\ \hline
        \multicolumn{1}{|r|}{\textbf{75\%}}  & 23.100000  & 40.800000  & 24.936000         & 0.505984       & 0.699776            \\ \hline
        \multicolumn{1}{|r|}{\textbf{max}}   & 103.950000 & 68.000000  & 103.952224        & 3.141593       & 1.570796            \\ \hline
    \end{tabular}
    \caption{Description du dataset final}
    \label{tab:describe_dataset}
\end{table}
\noindent Pour cela, nous allons utiliser un pitch chart.
...
\noindent Maintenant, nous allons nous focaliser sur la détection d'éventuelles "outliers".
...
\noindent Grâce à la figure \ref{fig:analyse_outlier2}, plusieurs observations peuvent être faites. 
...
\end{figure}
\newpage
\noindent Grâce à cette visualisation approfondie, nous avons pu acquérir une compréhension approfondie des données et des relations entre les différentes variables. 
...
\noindent Dans cette section, nous allons discuter de la méthodologie utilisée pour résoudre le problème de prédiction de la réussite d'un tir au but.
...
\noindent Plusieurs modèles vont être utlisés pour résoudre ce problème.
...
\noindent Pour chaque modèle, nous allons utiliser la cross validation pour choisir le meilleur set d'hyper paramètres.
...
Cette section consiste à montrer les sets d'hyper paramètres qui seront choisis pour chaque modèle.
Voici le tableau qui décrit quels sont les jeu d'hyper paramètres utilisés pour chacun des modèles.
